...
export function authControllerRegister(
  ...
  return request<Request.UnwrapApiResponse<LoginModule.AuthProfileResponseDto>>({
...
export function authControllerLogin(body: LoginModule.LoginDto, options?: { [key: string]: any }) {
  return request<Request.UnwrapApiResponse<LoginModule.AuthTokensResponseDto>>({
    url: `/api/auth/login`,
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
export function authControllerLogout(options?: { [key: string]: any }) {
  return request<Request.UnwrapApiResponse<LoginModule.OperationMessageResponseDto>>({
    url: `/api/auth/logout`,
    method: 'POST',
    ...(options || {}),
  })
